...
return new class extends Migration
{
    public function up()
    {
        Schema::create('main_budget_pending', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('stage', 255)->default('MANAGEMENT')->notNullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('main_budget_pending');
    }
}; 