...
use App\Models\InsuranceList;
use App\Services\CreditAndDebitService;
use Illuminate\Support\Facades\DB;


class InsuranceCharges extends Component
{
    ...
    {
        $this->intangibleAssets = InsuranceList::all();
    }
    ...
    {
        $asset = InsuranceList::findOrFail($id);
    ...
    public function update()
    {
        ...
        if ($this->assetId) {
            $asset = InsuranceList::find($this->assetId);
            $asset->update([
                'name' => $this->name,
                'type' => $this->type,
                'value' => $this->value,
    ...
    {
        return view('livewire.accounting.insurance-charges');
    }
