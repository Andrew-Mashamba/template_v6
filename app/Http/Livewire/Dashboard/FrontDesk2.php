...
class FrontDesk2 extends Component
{
...
//        $this->registrationFee = institutions::where('institution_id',Session::get('institution'))->value('application_fee');
    ...
    private function processNewLoan($client)
    {
        DB::transaction(function () use ($client) {
            ...
            $initialStage = LoanStage::where('loan_product_id', $product_id)
                    ->orderBy('created_at', 'asc')
                    ->first()
                    ->committee_id ?? null;
            $stage_value = $initialStage ? DB::table('committees')->where('id', $initialStage)->value('name') : '';
            ...
            $loanID = LoansModel::create([
                ...
                'loan_id' => time(),
                'selectedLoan' => $this->account_number ?? null,
...
private function recordGeneralLedger($accountNumber, $newBalance, $amount, $description, $type)
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.front-desk2');
    }
