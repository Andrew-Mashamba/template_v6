...
/**
 * Incoming API Tests Runner
 * 
 * This script runs all tests for APIs exposed by the system (incoming API calls)
 */
...
require_once __DIR__ . '/incoming-api-tests/AccountSetupApiTest.php';
...
class IncomingApiTestRunner
{
    ...
    public function __construct()
    {
        ...
        $this->tests = [
            ...
            // 'Account Setup API' => new AccountSetupApiTest(), // SKIPPED
    ...
    public function runAllTests()
    {
        ...
        echo "Base URL: " . env('APP_URL', 'http://127.0.0.1:8000') . "/api\n";
        echo "\n";
...
if (php_sapi_name() === 'cli') {
    ...
    if ($argc > 1 && $argv[1] === '--api') {
        ...
        if (isset($argv[2])) {
            ...
            echo "\nUsage: php run-incoming-api-tests.php [--api \"API Name\"]\n";
