...
// Common actions for the module based on the blade template
$actions = ['view', 'create', 'edit', 'delete', 'manage', 'export', 'employees', 'payroll', 'leave', 'attendance', 'requests'];

echo "Adding hr module permissions...\n\n";
...
foreach ($actions as $action) {
    ...
    if (!$exists) {
        ...
        DB::table('permissions')->insert([
            ...
            'description' => 'HR - ' . ucfirst($action) . ' permission',
            'module' => $module,
            'action' => $action,
            'is_system' => false,
            'guard_name' => 'web',
...
echo "\n";
echo "Assigning hr permissions to IT Manager role...\n\n";
...
echo "Found " . count($permissionIds) . " hr permissions.\n\n";
...
echo "\n";
echo "✅ HR permissions setup complete!\n";
echo "The IT Manager role now has full access to Human Resources Management.\n";
echo "\n";
