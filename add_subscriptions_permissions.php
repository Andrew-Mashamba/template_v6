...
echo "Adding subscriptions module permissions...\n\n";
...
foreach ($actions as $action) {
    ...
    if (!$exists) {
        ...
        DB::table('permissions')->insert([
            ...
            'description' => 'Subscriptions - ' . ucfirst($action) . ' permission',
            'module' => $module,
            'action' => $action,
            'is_system' => false,
            'guard_name' => 'web',
...
echo "\n";
echo "Assigning subscriptions permissions to IT Manager role...\n\n";
...
// Get all subscriptions permissions
$permissionIds = DB::table('permissions')
    ->where('name', 'like', $module . '.%')
    ->pluck('id', 'name');

echo "Found " . count($permissionIds) . " subscriptions permissions.\n\n";
...
echo "\n";
echo "✅ Subscriptions permissions setup complete!\n";
echo "The IT Manager role now has full access to Subscriptions Management.\n";
echo "\n";
