    ...
    <div class="bg-gray-100 rounded-lg shadow-sm ">
        <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                ...
                <select wire:model.bounce="serviceToEdit" name="serviceToEdit" id="serviceToEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <select wire:model.bounce="NewNode" name="NewNode" id="NewNode" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <td class="py-4 pl-4 sm:pl-6 w-1/4 ">
                                        <div class="flex ">
                                            <div aria-label="briefcase icon" role="img" tabindex="0" class="flex items-center justify-center w-8 h-8 bg-blue-100 rounded focus:outline-none">
                                                <button type="button" class="relative inline-flex items-center p-1 text-sm font-medium text-center text-white  rounded-full bg-blue-100 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-900 dark:hover:bg-blue-900 dark:focus:ring-blue-800">
