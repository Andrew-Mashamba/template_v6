                            ...
                            @case(2)
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                    @switch($selectedPaymentType)
                                        @case('money_transfer')
                                            {{-- Three-Phase Money Transfer Workflow --}}
                                            @php
                                                $currentPhase = $currentPhase ?? 'form';
                                            ...
                                            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                                                <div class="flex items-center justify-center">
                                                    <div class="flex items-center space-x-8">
                                                        {{-- Step 1: Form --}}
                                                        <div class="flex items-center space-x-2">
                                                            <div class="w-8 h-8 rounded-full flex items-center justify-center border-2 @if($currentPhase === 'form') border-blue-500 bg-blue-500 text-white @elseif(in_array($currentPhase, ['verify', 'complete'])) border-green-500 bg-green-500 text-white @else border-gray-300 bg-gray-100 text-gray-500 @endif">
                                                            ...
                                                            <span class="text-sm font-medium @if($currentPhase === 'form') text-blue-600 @elseif(in_array($currentPhase, ['verify', 'complete'])) text-green-600 @else text-gray-500 @endif">Form</span>
                                                        </div>
                                                        ...
                                                        {{-- Step 2: Verify --}}
                                                        <div class="flex items-center space-x-2">
                                                            <div class="w-8 h-8 rounded-full flex items-center justify-center border-2 @if($currentPhase === 'verify') border-blue-500 bg-blue-500 text-white @elseif($currentPhase === 'complete') border-green-500 bg-green-500 text-white @else border-gray-300 bg-gray-100 text-gray-500 @endif">
                                                            ...
                                                            <span class="text-sm font-medium @if($currentPhase === 'verify') text-blue-600 @elseif($currentPhase === 'complete') text-green-600 @else text-gray-500 @endif">Verify</span>
                                                        </div>
                                                        ...
                                                        {{-- Step 3: Complete --}}
                                                        <div class="flex items-center space-x-2">
                                                            <div class="w-8 h-8 rounded-full flex items-center justify-center border-2 @if($currentPhase === 'complete') border-green-500 bg-green-500 text-white @else border-gray-300 bg-gray-100 text-gray-500 @endif">
                                                                @if($currentPhase === 'complete')
                                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                                                    </svg>
                                                            ...
                                                            <span class="text-sm font-medium @if($currentPhase === 'complete') text-green-600 @else text-gray-500 @endif">Complete</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="grid grid-cols-2 gap-4">
                                                                        <button 
                                                                            ...
                                                                            class="relative p-4 border-2 rounded-lg transition-all duration-200 @if($transferType === 'bank') border-blue-500 bg-blue-50 @else border-gray-200 hover:border-gray-300 @endif"
                                                                        >
                                                                            <div class="flex items-center space-x-3">
                                                                        ...
                                                                        <button 
                                                                            ...
                                                                            class="relative p-4 border-2 rounded-lg transition-all duration-200 @if($transferType === 'wallet') border-blue-500 bg-blue-50 @else border-gray-200 hover:border-gray-300 @endif"
                                                                        >
                                                                            <div class="flex items-center space-x-3">
                                                                ...
                                                                <form wire:submit.prevent="verifyBeneficiary" class="space-y-4">
                                                                    ...
                                                                    <div class="flex justify-end pt-4">
                                                                        <button type="submit" 
                                                                            ...
                                                                            <span wire:loading wire:target="verifyBeneficiary" >
                                                                                <div class="flex items-center">
                                                        ...
                                                        <div class="space-y-6">
                                                            <div>
                                                                ...
                                                                <div class="bg-gray-50 rounded-lg p-6">
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        ...
                                                                        <div class="flex justify-between font-semibold">
                                                                            ...
                                                                            <span class="text-gray-900">{{ number_format($amount ?? 0, 2) }} TZS</span>
                                                                        </div>
                                                                        <div class="flex justify-between">
                                                                ...
                                                                <div class="flex justify-between pt-4">
                                                                    <button type="button" 
                                                                            wire:click="$set('currentPhase', 'form')"
                                                            ...
                                                            <div class="bg-gray-50 rounded-lg p-6">
                                                                ...
                                                                <div class="space-y-3">
                                                                    <div class="flex justify-between">
                                                                        ...
                                                                        <span class="font-medium font-mono">{{ $engineRef ?? 'REF' . rand(100000, 999999) }}</span>
                                                                    </div>
                                                                    <div class="flex justify-between">
