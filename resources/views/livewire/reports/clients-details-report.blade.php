...
{{--                    @enderror--}}
                ...
                <div class="flex justify-end w-auto" >
                    ...
                    @if($this->client_type=="MULTIPLE")
                        ...
                        <div>
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Member Number</label>
                            <label for="first_name" class="block mb-2 text-xs font-medium text-gray-900 ">for more than one client put a comma in between</label>
                            <input wire:model="custome_client_number" type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     " placeholder="eg. 0001,0002" required="">
                        </div>
                                @endif
