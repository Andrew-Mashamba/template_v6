                    ...
                    <div class="flex items-center space-x-2 bg-gray-50 p-2 rounded-lg border border-gray-200">
                        ...
                        <div class="relative">
                            <select wire:model="massActionOption" 
                                class="block w-48 pl-3 pr-10 py-2 text-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white" 
