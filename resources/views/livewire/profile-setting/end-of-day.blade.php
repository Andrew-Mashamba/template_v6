...
<div>
    ...
    <style>
        ...
        .main-color-bg-hover:hover {
            background-color: #2D3D88; /* Change this to the desired hover color for the main color */
            color: white;
        }
        .icon-hover:hover {
            color: #2D3D88; /* Change this to the desired hover color for the main color */
        }
    ...
    <div class="w-full flex items-center justify-center h-full bg-gray-100  p-2 ">
        <section
                class="w-full p-6  rounded-lg shadow-gray-300 bg-white"
        >
          ...
          <span class="w-8 h-8 shrink-0 mr-4 rounded-full bg-blue-50 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500" width="24" height="24" stroke-linecap="round" stroke-linejoin="round" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
              ...
              <span
                      class="h-full main-color-bg w-full block rounded-full"
                      style="width: 62%"
              ></span>
                        </div>
                    </div>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <footer class="border-t border-gray-100 pt-4">
                <p class="text-sm text-gray-500 text-center">
                    <button class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white main-color-bg rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  " >
                    RERUN PROCESSES
                    </button>
                </p>
            </footer>
