                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                        ...
                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                            <a href="#" class="bg-blue-500 hover:bg-blue-900 text-white py-2 px-4 rounded">Contact</a>
            ...
            <div class="w-3/4 ">
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex justify-between">
                        ...
                        <button wire:click="hide" type="button" class="w-10 h-10 text-white bg-red-200 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-full text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-blue-200 dark:hover:bg-blue-200 dark:focus:ring-blue-200">
