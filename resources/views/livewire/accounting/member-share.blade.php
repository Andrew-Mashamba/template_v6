<div class=" bg-white p-4 mb-4 ">
    ...
    <div class="container mx-auto mt-8   ">
        <h4 class="text-xl font-bold mb-4  flex justify-center item-center  p-4 "> MEMBER SHARE AS ON {{ now()->format("Y-M-d") }}, NBC SACCOS LTD</h4>
            ...
            <table class="min-w-full bg-white border border-gray-200 text-sm ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border-blue-200 border ">{{ DB::table('share_registers')->where('client_number', $sub_account->client_number)->where('share_product_id', $product->sub_category_code)->sum('number_of_shares') }}</td>
