            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex gap-4 mb-6">
                    ...
                    <select wire:model="filterProduct" class="px-4 py-2 border border-gray-300 rounded-lg">
                        ...
                        @foreach($loanProducts as $id => $name)
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($loansWithProvisions as $loan)
                            <tr>
    ...
    if (movementCtx) {
        new Chart(movementCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Stage 1',
                    data: @json($provisionMovement->pluck('stage1')),
                    borderColor: 'rgba(34, 197, 94, 1)',
                    backgroundColor: 'rgba(34, 197, 94, 0.1)',
                    tension: 0.4
                }, {
                    label: 'Stage 2',
                    data: @json($provisionMovement->pluck('stage2')),
                    borderColor: 'rgba(251, 191, 36, 1)',
                    backgroundColor: 'rgba(251, 191, 36, 0.1)',
                    tension: 0.4
                }, {
                    label: 'Stage 3',
                    data: @json($provisionMovement->pluck('stage3')),
